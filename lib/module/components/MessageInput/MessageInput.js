...
var _jsxFileName = "/Users/federuiz/projects/stream-chat-react-native/src/components/MessageInput/MessageInput.tsx";
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              ...
              _loop = function _loop(_image2) {
                ...
                if (_image2.state === _utils.FileState.UPLOADED) {
                  attachments.push({
            ...
            case 27:
              if (_file2.state === _utils.FileState.UPLOADED) {
                attachments.push({
            ...
            case 33:
              if (editing && !(0, _MessagesContext.isEditingBoolean)(editing)) {
                ...
                try {
                  ...
                  setMentionedUsers([]);
                  setNumberOfUploads(function (prevNumberOfUploads) {
                    return prevNumberOfUploads - ((attachments == null ? void 0 : attachments.length) || 0);
                  });
                  setText('');
                } catch (_error) {
                  sending.current = false;
